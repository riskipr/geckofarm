...
<body class="bg-secondary">
    <div class="container-fluid border mb-4 mt-4 rounded-3 shadow bg-white">
        ...
        <header class="d-flex p-3 justify-content-center">
            ...
            <div class="ms-auto my-auto">
                <ul class="list-inline m-0">
                    ...
                    <li class="list-inline-item mx-4"><a href="akun.php" class="btn btn-primary btn-sm">Akun</a></li>
                </ul>
            </div>
        </header>
        <!-- banner -->
        ...
        <div class="row row-cols-3 gx-5 p-5">
            <?php $result = $conn->query("SELECT * FROM gecko"); ?>
            <?php if ($result && $result->num_rows > 0) { ?>
                <?php while ($pecah = $result->fetch_assoc()) { ?>
                    <div class="col mb-5">
                        <div class="card shadow">
                            <img src="admin/gambar/<?php echo $pecah['gambar_gecko']; ?> " class="card-img-top">
                            <div class="card-body">
